...
#define GOOMBA_BBOX_YELLOW_WIDTH      16
#define GOOMBA_BBOX_YELLOW_HEIGHT     15
#define GOOMBA_BBOX_RED_UNWALK_WIDTH  18
#define GOOMBA_BBOX_RED_UNWALK_HEIGHT 22
#define GOOMBA_BBOX_RED_WALK_WIDTH    18
#define GOOMBA_BBOX_RED_WALK_HEIGHT   17
